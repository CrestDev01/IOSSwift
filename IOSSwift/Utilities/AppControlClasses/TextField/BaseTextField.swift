...
/// UITextField class to manage different UI need for textfield which is not available default
...
//    }
    ...
    /**
     Base class function to set left view in textfiled
     - parameter bounds: Frame size for view
     - returns CGRect
     */
    ...
    /**
     Base class function to set right view in textfiled
     - parameter bounds: Frame size for view
     - returns CGRect
     */
    ...
    /**
     Method to set font
     - parameter fontEnum: Represent font info
     */
...
extension BaseTextField {
    /**
     Method to apply common theme for control
     */
    fileprivate func applyCommonTheme() {
        self.borderStyle = .none
        self.backgroundColor = UIColor.init(named: "#F5F5F6")
    }
