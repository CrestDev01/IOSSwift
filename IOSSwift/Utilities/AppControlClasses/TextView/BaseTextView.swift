...
/// Textview class to manage different UI need for textview which is not available default 
class BaseTextView: UITextView {
    ...
    /**
     Method to set font text style for textview
     */
...
extension BaseTextView {
    ...
    /**
     Method to set placeholder for textview
     */
    ...
    /**
     Method to update placeholder when user type any text in textview
     */
    ...
    /**
     Method to set default attribute for textview
     */
    ...
    /**
     Method to set padding for textview
     */
...
/**
 Method contain all necessary delegate method for textview
 */
