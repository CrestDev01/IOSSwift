...
extension UIFont {
    ...
    /**
    Class method to return font with size
     - parameter font: Represent Font enum
     - parameter fontSize: Represent Font size
     - returns UIFont
     */
    ...
    /**
     Method to return font with text style
     - parameter textStyle: Represent text style
     - returns UIFont
     */
...
//        let fontSize = UIFont.preferredFont(forTextStyle: textStyle).pointSize
    ...
    /**
    Method to log all available font
    */
    ...
    /**
     Method to return text style font
     - parameter textStyle: Represent text style
     - returns UIFont
     */
